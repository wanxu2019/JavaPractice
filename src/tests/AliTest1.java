...
/**
 * Created by Json Wan on 2018/5/27.
 * Description:
 */
...
//        scanner.next();
        ...
        list.add("aaa");
        list.add("ccc");
        ArrayList<String> copyedList = copyArrayList(list);
        //lambda特性使用
//        copyedList.sort(String::compareTo);
        copyedList.sort((e1, e2) -> e1.compareTo(e2));
        for (String s : copyedList) {
            show(s);
        }
        //测试A-Star算法
        testAStar();
